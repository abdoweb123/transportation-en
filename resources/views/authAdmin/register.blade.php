            ...
            <div class="row justify-content-center no-gutters vertical-align">
                ...
                <div class="col-lg-4 col-md-6 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">تسجيل أدمن جديد</h3>

                        <form method="POST" action="{{ route('registerTest') }}" enctype="multipart/form-data">
                            @csrf
