    ...
    <form wire:submit.prevent='store_update'>
        <div class="card-body col-md-8 offset-2">
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="vendor_id" class="mr-sm-2">vendors</label>
                    <select name="vendor_id" class="form-control mr-sm-2 p-2" id="" class="w-100 mb-10" wire:model.lazy='vendor_id'>
                    ...
                    @error('vendor_id')<span style="color: red"> {{ $message }}</span>@enderror
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input id="number_of_gudgets" type="number" class="form-control" wire:model.lazy='number_of_gudgets'>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input id="cost_of_gudget" type="number" class="form-control" wire:model.lazy='cost_of_gudget'>
                    @error('cost_of_gudget')<span style="color: red"> {{ $message }}</span>@enderror
                </div>
                <div class="col-md-6 mb-2">
                    <label for="fixing_cost" class="mr-sm-2">fixing_cost</label>
                    <input id="fixing_cost" type="number" class="form-control" wire:model.lazy='fixing_cost'>
